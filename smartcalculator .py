...
l1 = Label(win , text='I am a smart calculator',width=20 , padx=7, pady=7)
l1.place(x=160,y=10)
l2 = Label(win , text='How can i help you' , padx=7,pady=7,width=20)
l2.place(x=160,y=60)
l3 = Label(win , text='Enter any instruction to calculate' , padx=7,pady=7,width=40)
l3.place(x=110,y=110)

textin = StringVar()
e1 = Entry(win , width=30 , textvariable = textin)
e1.place(x=148,y=160)

b1 = Button(win , text='Just this' ,command=calculate ,activebackground="lightblue", activeforeground="blue", bg="blue")
